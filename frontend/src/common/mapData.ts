export const maps = {
  ...
  albasrah: {
    ...
    landscape: {
      loc_x: -203206.40625 + 508 * 100,
      loc_y: -203200.0 + 508 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 10.0,
      resolution_x: 3049,
  ...
  fallujah: {
    ...
    landscape: {
      loc_x: -204000.0 + 0 * 100,
      loc_y: -204000.0 + 0 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 100.0,
      resolution_x: 4081,
  ...
  foolsroad: {
    ...
    landscape: {
      loc_x: -261809.515625 + 1020 * 100,
      loc_y: -263130.0 + 765 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 320.0,
      resolution_x: 2806,
  ...
  kokan: {
    ...
    landscape: {
      loc_x: -107899.648438 - 508 * 50,
      loc_y: -107900.0 - 1270 * 50,
      scale_x: 50.0,
      scale_y: 50.0,
      scale_z: 100.0,
      resolution_x: 6097,
  ...
  logar: {
    ...
    landscape: {
      loc_x: -201598.0 + 630 * 99.98999,
      loc_y: -201598.0 + 756 * 99.98999,
      scale_x: 99.98999,
      scale_y: 99.98999,
      scale_z: 49.98999,
      resolution_x: 2773,
  ...
  mestia: {
    ...
    landscape: {
      loc_x: -231000.0 + 765 * 100,
      loc_y: -192695.453125 + 765 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 120.0,
      resolution_x: 3061,
  ...
  mutaha: {
    ...
    landscape: {
      loc_x: -382502.0 + 2040 * 100,
      loc_y: -382500.0 + 2040 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 30.0,
      resolution_x: 4081,
  ...
  sumari: {
    ...
    landscape: {
      loc_x: -99200.820312 + 310 * 100,
      loc_y: -99199.453125 + 620 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 75.0,
      resolution_x: 1427,
  ...
  tallil: {
    ...
    landscape: {
      loc_x: -203198.625 - 254 * 100,
      loc_y: -203200.65625 - 254 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 125.0,
      resolution_x: 4573,
  ...
  yehorivka: {
    ...
    landscape: {
      loc_x: -406397.0 + 762 * 100,
      loc_y: -406400.0 + 762 * 100,
      scale_x: 100.0,
      scale_y: 100.0,
      scale_z: 400.0,
      resolution_x: 6351,
